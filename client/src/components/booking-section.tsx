        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <div className="mt-8 text-center">
              <p className="text-warm-gray mb-4">如有任何問題，歡迎透過 LINE 或 WhatsApp 聯絡我們</p>
              <div className="flex justify-center space-x-6">
                <div 
                  className="flex items-center space-x-2 bg-green-500 text-white px-6 py-3 rounded-full"
                ...
                <div 
                  className="flex items-center space-x-2 bg-green-400 text-white px-6 py-3 rounded-full"
